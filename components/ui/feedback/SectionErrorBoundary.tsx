        ...
        if (this.state.hasError) {
            ...
            return (
                <div className="p-6 border border-rose-500/30 bg-rose-500/10 rounded-xl text-center">
                    ...
                    <p className="text-xs text-zinc-400 mb-3">Wystąpił problem z wyświetleniem tej zawartości.</p>
                    <button
                        onClick={this.handleRetry}
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 rounded text-xs transition-colors border border-zinc-700"
                    >
