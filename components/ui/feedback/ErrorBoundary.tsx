            ...
            return (
                <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-950 p-6 text-center">
                    ...
                    <button
                        ...
                        className="py-3 px-6 bg-amber-600 text-white border-none rounded-lg text-base font-semibold cursor-pointer shadow-lg hover:bg-amber-700 transition-colors"
                    >
                        🔄 Odśwież stronę
                    </button>
                </div>
