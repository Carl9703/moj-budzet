    ...
    return createPortal(
        ...
        >
            <motion.div
                ...
                className="w-full max-w-lg relative overflow-hidden rounded-[2.5rem] border border-white/10 shadow-2xl flex flex-col max-h-[90dvh] bg-slate-900/90 backdrop-blur-2xl"
            ...
            >
                ...
                <div className="relative px-8 pt-8 pb-4 flex-shrink-0">
                    <div className="flex justify-between items-center">
                        <h2 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400 tracking-tight flex items-center gap-3">
                            {title}
                        </h2>
                        <button
                            onClick={onClose}
