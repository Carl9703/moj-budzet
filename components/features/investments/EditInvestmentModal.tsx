        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90dvh]"
                >
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-4 flex-1 overflow-y-auto custom-scrollbar">
                        ...
                        {formData.type === 'PPK' ? (
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-zinc-400 text-sm font-medium mb-2">Aktualna Wartość</label>
                                    <input
                                        type="number"
                                        step="0.01"
                                ...
                                <div>
                                    <label className="block text-zinc-400 text-sm font-medium mb-2">Twoje Wpłaty</label>
                                    <input
                                        type="number"
                                        step="0.01"
                            ...
                            <>
                                <div>
                                    <label className="block text-zinc-400 text-sm font-medium mb-2">Ilość</label>
                                    <input
                                        type="number"
                                        step="0.00000001"
                                ...
                                <div>
                                    <label className="block text-zinc-400 text-sm font-medium mb-2">Średnia Cena Zakupu (PLN)</label>
                                    <input
                                        type="number"
                                        step="0.01"
                        ...
                        <div>
                            <label className="block text-zinc-400 text-sm font-medium mb-2">Typ</label>
                        ...
                        <div className="flex gap-3 pt-4">
                            <button
                                type="button"
                                onClick={onClose}
                                className="flex-1 px-6 py-3 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 rounded-xl font-bold transition-all active:scale-95"
                            >
                                Anuluj
                            </button>
                            <button
                                type="submit"
                                disabled={loading}
                                className="flex-1 px-6 py-3 bg-amber-600 hover:bg-amber-700 disabled:bg-zinc-800 disabled:text-zinc-600 text-white rounded-xl font-bold transition-all shadow-lg shadow-amber-600/20 active:scale-95 flex items-center justify-center gap-2"
                            >
