...
function ChartsSkeleton() {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-slate-800/50 rounded-xl p-6 h-80 animate-pulse">
                <div className="h-4 w-32 bg-slate-700 rounded mb-4" />
                <div className="h-60 bg-slate-700/50 rounded-lg" />
            </div>
            <div className="bg-slate-800/50 rounded-xl p-6 h-80 animate-pulse">
                <div className="h-4 w-32 bg-slate-700 rounded mb-4" />
                <div className="h-60 bg-slate-700/50 rounded-lg" />
...
function TrendsSkeleton() {
    return (
        <div className="bg-slate-800/50 rounded-xl p-6 h-96 animate-pulse">
