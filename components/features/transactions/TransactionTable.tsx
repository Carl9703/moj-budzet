...
export function TransactionTable({ transactions, onTransactionDeleted, loading = false }: TransactionTableProps) {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const response = await authorizedFetch(`/api/transactions/${deleteModal.transactionId}`, {
        method: 'DELETE'
      })
  ...
  return (
    <div style={{
      ...
      <ConfirmationModal
        ...
        title="Usuń transakcję"
        message={`Czy na pewno chcesz usunąć transakcję "${deleteModal.transactionDescription}"? Ta operacja jest nieodwracalna.`}
        confirmText="Usuń"
        cancelText="Anuluj"
        type="danger"
