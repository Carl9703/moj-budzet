...
export function ArchivedMonthCard({ monthData, onClick }: ArchivedMonthCardProps) {
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className="p-0 cursor-pointer overflow-hidden group relative rounded-3xl border border-white/5 bg-slate-900/50 backdrop-blur-xl shadow-xl transition-all duration-300"
    >
      ...
      <div className="p-6 relative z-10">
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-white/50 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-500 transform group-hover:rotate-45 shadow-inner">
            <ArrowRight size={18} />
          </div>
        </div>
        ...
        {/* Balance */}
        <div className="p-5 mb-4 rounded-3xl border border-white/5 bg-slate-950/40 shadow-inner">
          ...
          <div className="flex justify-between items-center mt-3">
            <span className="text-[10px] text-slate-600 font-black uppercase tracking-widest">Stopa oszczędności</span>
