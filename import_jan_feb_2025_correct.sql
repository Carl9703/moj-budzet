...
-- TYLKO STYCZEŃ I LUTY 2025 (POPRAWNE DANE)
...
-- ========================================
-- PODSUMOWANIE IMPORTU - STYCZEŃ I LUTY 2025
-- ========================================
-- 
-- PRZYCHODY (5 transakcji):
-- - Styczeń: 5 212,97 zł (2 transakcje)
-- - Luty: 8 516,72 zł (3 transakcje)
-- RAZEM PRZYCHODY: 13 729,69 zł
-- 
-- WYDATKI (26 transakcji):
-- - Styczeń: 4 551,10 zł (13 transakcji)
-- - Luty: 3 456,11 zł (13 transakcji)
-- RAZEM WYDATKI: 8 007,21 zł
-- 
-- SALDO: +5 722,48 zł 💰
-- 
-- Mapowanie kategorii:
